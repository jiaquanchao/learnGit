...
<html>
  ...
  <body>
 	<s:form action="action_add" id="addNews" onsubmit="return $(this).form('validate');" namespace="/people" >
 	  <label for="name">姓名：</label>
		<input class="easyui-validatebox" id="title" type="text" required="true" name="people.name" value="${people.name }"/><br/>
		<label for="name">性别：</label>
		<s:radio  list="#{'男':'男','女':'女'}" listKey="key" listValue="value" value="'男'" name="people.sex"/><br/>
		<label for="name">年龄：</label>
		<input class="easyui-validatebox" type="text" name="people.age" required="true" onkeyup="this.value=this.value.replace(/\D/g,'')" value="${people.age}"/><br/>
		<label for="name">出生年月：</label>
		<input class="easyui-validatebox" id="birthday" type="text" name="people.birthday" value="${people.birthday}"/><br/>
		<label for="name">所属城市：</label>
		<input id="type" name="typeid" type="text" readonly="readonly" value=""/><br/>
